...
public class SearchCoursePage extends PageObject {
    public static final Target BUTTON_UC = Target.the("Seleciona opción Universidad Choucair")
            .located(By.xpath("//strong[contains(text(),'Universidad')]"));
    public static final Target INPUT_COURSE = Target.the("Ingresar nombre del curso")
            .located(By.id("coursesearchbox"));
    public static final Target BUTTON_GO = Target.the("Buscar el Curso")
            .located(By.xpath("//button[@class='btn btn-secondary']"));
    public static final Target SELECT_COURSE = Target.the("Buscar el Curso")
